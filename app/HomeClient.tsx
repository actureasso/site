...
export default function HomeClient() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Banner */}
      <section className="gradient-modern-blue text-white pt-28 md:pt-36 pb-24 md:pb-32 px-4 animate-gradient relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            <AnimatedCard delay={0.1} className="h-full">
              ...
              >
                ...
                <ul className="space-y-2 mb-6 text-gray-600 flex-1">
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>• Quartier Connect - Animation de l&apos;espace public</motion.li>
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>• Ateliers d&apos;Inclusion Numérique (AIN)</motion.li>
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }}>• CLIC - Accompagnement scolaire</motion.li>
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.6 }}>• Séjours jeunes</motion.li>
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.7 }}>• Accompagnement à l&apos;insertion</motion.li>
                </ul>
                <Link href="/asso" className="inline-block bg-gradient-to-r from-acture-blue to-blue-600 text-white px-6 py-3 rounded-modern hover:shadow-colored transition-smooth mt-auto font-semibold btn-modern">
                  En savoir plus →
                </Link>
              </motion.div>
            </AnimatedCard>
            <AnimatedCard delay={0.2} className="h-full">
              ...
              >
                ...
                <ul className="space-y-2 mb-6 text-gray-600 flex-1">
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>• REMN - Responsable d&apos;Espace de Médiation Numérique</motion.li>
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }}>• Re Connect - Reconditionnement d&apos;outils numériques</motion.li>
                  <motion.li initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.6 }}>• VIA - Vers l&apos;Insertion par l&apos;Animation</motion.li>
                </ul>
                <Link href="/academie" className="inline-block bg-gradient-to-r from-acture-green to-green-600 text-white px-6 py-3 rounded-modern hover:shadow-colored-green transition-smooth mt-auto font-semibold btn-modern">
                  En savoir plus →
                </Link>
              </motion.div>
            </AnimatedCard>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            {[
              { href: "/asso#ateliers", text: "Participer à un atelier", color: "blue" },
              { href: "/academie#inscriptions", text: "S'inscrire à une formation", color: "green" },
              { href: "/soutien", text: "Nous soutenir", color: "yellow" },
            ].map((item, index) => (
